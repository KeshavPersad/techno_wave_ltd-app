...
<title>Techno Wave Ltd. || {{''}}About Us</title>	
					...
					<div class="our-staff">
						<div 
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="LEONA">
										<figure><img src="{{ asset('template0/images/member-leona.jpg') }}" alt="LEONA"></figure>
									</a>
								</div>
								<div class="info">
									<b class="name">Keshav Persad</b>
									<span class="title">Director</span>
									<p class="desc">Contrary to popular belief, Keshav Persad is not simply random text...</p>
								</div>
							</div>
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="LUCIA">
										<figure><img src="{{ asset('template0/images/member-lucia.jpg') }}" alt="LUCIA"></figure>
									</a>
								</div>
								<div class="info">
									<b class="name">Rianna Maharaj</b>
									<span class="title">Manager</span>
									<p class="desc">Contrary to popular belief, Rianna Maharaj is not simply random text...</p>
								</div>
							</div>
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="NANA">
										<figure><img src="{{ asset('template0/images/member-nana.jpg') }}" alt="NANA"></figure>
									</a>
								</div>
								<div class="info">
									<b class="name">Nehru Captaan</b>
									<span class="title">Marketer</span>
									<p class="desc">Contrary to popular belief, Nehru Captaa is not simply random text...</p>
								</div>
							</div>
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="BRAUM">
										<figure><img src="{{ asset('template0/images/member-braum.jpg') }}" alt="BRAUM"></figure>
									</a>
								</div>
								<div class="info">
									<b class="name">Shiv Boxer</b>
									<span class="title">Member</span>
									<p class="desc">Contrary to popular belief, Shiv Boxer is not simply random text...</p>
								</div>
							</div>
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="LUCIA">
										<figure><img src="{{ asset('template0/images/member-nana.jpg') }}" alt="LUCIA"></figure>
									</a>
								</div>
								<div class="info">
									<b class="name">Sharda Sinnana</b>
									<span class="title">Manager</span>
									<p class="desc">Contrary to popular belief, Sharda Sinnana is not simply random text...</p>
								</div>
							</div>
							...
							<div class="team-member equal-elem">
								<div class="media">
									<a href="#" title="NANA">
										<figure><img src="{{ asset('template0/images/member-lucia.jpg') }}" alt="NANA"></figure>
									</a>
								</div>
								<div class="info">
									<b class="name">Sat Godfather</b>
									<span class="title">Marketer</span>
									<p class="desc">Contrary to popular belief, Sat Godfather is not simply random text...</p>
								</div>
							</div>
